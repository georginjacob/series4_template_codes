...
fprintf(conditionsFile, ['Condition\t',   'Info\t',          'Frequency\t',     'Block\t',      'Timing File\t',...
...
taskObj13Distractor4 = sprintf('pic(%s, 0, 0)', distractorName);
taskObj14Distractor5 = sprintf('pic(%s, 0, 0)', distractorName);
taskObj15Distractor6 = sprintf('pic(%s, 0, 0)', distractorName);
taskObj16Distractor7 = sprintf('pic(%s, 0, 0)', distractorName);
taskObj17Distractor8 = sprintf('pic(%s, 0, 0)', distractorName);

% PRINT to file
    fprintf(conditionsFile, ['%d\t', '%s\t', '%d\t', '%d\t', '%s\t',...
        '%s\t', '%s\t', '%s\t', '%s\t', '%s\t',...
        '%s\t', '%s\t', '%s\t', '%s\t', '%s\t',...
        '%s\t', '%s\t', '%s\t', '%s\t', '%s\t',...
        '%s\t', '%s\n'],...
    ...
    taskObj11Distractor2, taskObj12Distractor3, taskObj13Distractor4, taskObj14Distractor5, taskObj15Distractor6,...
    taskObj16Distractor7, taskObj17Distractor8);
